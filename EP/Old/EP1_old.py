...
def troco(vT, i = 0, mult = None, m = None): #falta documentar e escrever uma versão melhor
...
def programa(cup, c, a, g, l, lv, m, cc, off = 0): #falta documentar
    ...
    if cup > 0:
        ...
        if (id1 == id2 == id3 == id4 == id5 == None):
            ...
            next = id5 if (id5 != None) else id4 if (id4 != None) else id3 if (id3 != None) else id2 if (id2 != None) else id1
...
def main():
    limpa()
    programa(10, 0, 500, 10, 500, 500, 70, 100)
